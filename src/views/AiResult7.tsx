...
export default function AiResult7({ navigate, uploadedImage }: { navigate: (view: string) => void, uploadedImage?: string | null }) {
  const customStyles = `
    .bg-guofeng-corners {
            ...
            <div className="paper-card rounded-xl w-full flex-1 min-h-0 p-3 flex flex-col relative">
              ...
              <div className="card-content w-full flex-grow relative rounded-lg overflow-hidden border-2 border-primary-container/50 bg-surface-container-lowest flex items-center justify-center min-h-[120px]">
                <img 
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-XflDk-dhyG85qxjt9XL8tey7aZ3aUvlF17yZgx2ciAQ_DbxOfSY9yv0GdFx7pdwnDcPtL_3WhyDG0OaUw30RROh6wTothmnCrel0Gm88f7p5wd261sKSz7YqSoXhOBe_dH7wgIqas2UyxlDv8ETm8SzbrvfCRxZrVJmNfRHGRxbcfbULNKfmVzBPyPskZrKbzDgGmDVyeBPdiy2oJOzWUCMMNO8lcw9pQ7wvg3XZLAk-Q7Blw153vl45waEl2fTeQi68uzzA25I" 
                />
              </div>
            </div>
          </div>
              ...
              <div className="card-content h-full flex flex-col">
                ...
                <div className="flex justify-between items-start border-b border-surface-variant pb-4 mb-2">
                  <div>
                    <div className="flex items-center gap-3">
                      <h2 className="text-display-lg font-display-lg text-on-surface">菊花</h2>
                      <span className="text-title-sm font-title-sm text-outline">(Jú Huā)</span>
                    </div>
                ...
                <div className="flex-grow overflow-y-auto pr-2 space-y-4 custom-scrollbar">
                  ...
                  <div className="bg-tertiary-container/20 rounded-lg p-3 border border-tertiary-fixed-dim">
                    ...
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      菊花被古人称为"花中君子"，因为它在秋天凉快的时候才盛开，非常勇敢。
                    </p>
                  </div>
