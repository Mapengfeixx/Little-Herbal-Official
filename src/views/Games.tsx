...
export default function Games({ navigate }: { navigate: (view: string) => void }) {
  const customStyles = `
    .map-path {
  ...
  return (
    <div className="bg-background text-on-surface font-body-base flex flex-col h-screen overflow-hidden">
      ...
      <main 
        ...
        style={{ 
            backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCr9_mrZpCBgR8MQIlr8WthJz9NKN17KAY0hZBvJEKgxJZ7t1jkqRO0H4vvLvfEh017mjDlJCpdUIL9QMYh3JUwLkjRVkHS0T4uag-PuwUKtTxKY3bnr8TgRvYGbFW4CvcyBoOycS4Ghl7KfrpmMm4FxPm7X8y2oNVhtdyhrRIE9YqwUTXG709j24UNOyVsdyKVYFv-m6ELqzJQeRLL06mn7bdL34XUhy8MDsOBvjqNLzS14DgYFoMtfYVmn6mkSyx_zIrw7rKyffM')", 
      ...
      >
        ...
        <div className="absolute top-6 left-6 z-40 bg-surface-container-low/90 backdrop-blur-md rounded-xl shadow-lg border-2 border-primary/20 p-4 flex flex-col gap-2 w-64 max-w-[90vw]">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-primary-container border-2 border-primary flex items-center justify-center overflow-hidden shrink-0">
              <span className="material-symbols-outlined text-primary text-[28px]" style={{ fontVariationSettings: "'FILL' 1" }}>face</span>
            </div>
            <div>
              <h2 className="text-title-sm font-title-sm text-on-surface">小小本草官</h2>
              <p className="text-body-base font-body-base text-primary font-bold">本草小学徒</p>
            </div>
          </div>
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none" preserveAspectRatio="none">
          <path className="map-path opacity-60" d="M 20% 70% Q 30% 40% 50% 50% T 70% 30% T 85% 65%" fill="none" stroke="#7ba361" strokeLinecap="round" strokeWidth="6"></path>
        </svg>
        ...
        >
          <div className="relative flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-surface shadow-xl border-4 border-primary flex items-center justify-center z-10 bg-gradient-to-br from-surface to-surface-container-high">
              <span className="material-symbols-outlined text-primary text-[32px]" style={{ fontVariationSettings: "'FILL' 1" }}>image_search</span>
            </div>
            <div className="mt-2 bg-surface-container-high/90 backdrop-blur-sm px-3 py-1 rounded-full border border-outline-variant shadow-sm group-hover:bg-primary group-hover:text-on-primary transition-colors">
              <span className="text-title-sm font-title-sm whitespace-nowrap">看图识本草</span>
            </div>
        ...
        <div className="absolute top-[45%] left-[40%] level-node group cursor-pointer opacity-80">
          <div className="relative flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-surface shadow-xl border-4 border-tertiary flex items-center justify-center z-10 bg-gradient-to-br from-surface to-surface-container-high">
              <span className="material-symbols-outlined text-tertiary text-[32px]">group_add</span>
            </div>
            ...
            <div className="mt-2 bg-surface-container-high/90 backdrop-blur-sm px-3 py-1 rounded-full border border-outline-variant shadow-sm text-on-surface-variant">
              <span className="text-title-sm font-title-sm whitespace-nowrap">特征找朋友</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-[25%] left-[65%] level-node group cursor-pointer opacity-80">
          <div className="relative flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-surface shadow-xl border-4 border-tertiary flex items-center justify-center z-10 bg-gradient-to-br from-surface to-surface-container-high">
              <span className="material-symbols-outlined text-tertiary text-[32px]">menu_book</span>
            </div>
            <div className="absolute -top-3 -right-3 bg-surface rounded-full p-1 shadow-md border border-outline-variant z-20">
              <span className="material-symbols-outlined text-outline text-[16px]">lock</span>
            </div>
            <div className="mt-2 bg-surface-container-high/90 backdrop-blur-sm px-3 py-1 rounded-full border border-outline-variant shadow-sm text-on-surface-variant">
              <span className="text-title-sm font-title-sm whitespace-nowrap">绘本小问答</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-[45%] left-[80%] level-node group cursor-pointer opacity-80">
          <div className="relative flex flex-col items-center">
            <div className="w-16 h-16 rounded-full bg-surface shadow-xl border-4 border-tertiary flex items-center justify-center z-10 bg-gradient-to-br from-surface to-surface-container-high">
              <span className="material-symbols-outlined text-tertiary text-[32px]">health_and_safety</span>
            </div>
            <div className="absolute -top-3 -right-3 bg-surface rounded-full p-1 shadow-md border border-outline-variant z-20">
              <span className="material-symbols-outlined text-outline text-[16px]">lock</span>
            </div>
            <div className="mt-2 bg-surface-container-high/90 backdrop-blur-sm px-3 py-1 rounded-full border border-outline-variant shadow-sm text-on-surface-variant">
              <span className="text-title-sm font-title-sm whitespace-nowrap">安全小卫士</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-[75%] left-[75%] level-node group cursor-pointer opacity-80">
          <div className="relative flex flex-col items-center">
            <div className="w-20 h-20 rounded-full bg-surface shadow-xl border-4 border-tertiary flex items-center justify-center z-10 bg-gradient-to-br from-surface to-surface-container-high">
              <span className="material-symbols-outlined text-tertiary text-[40px]">explore</span>
            </div>
            <div className="absolute -top-3 -right-3 bg-surface rounded-full p-1 shadow-md border border-outline-variant z-20">
            ...
            <div className="mt-2 bg-surface-container-high/90 backdrop-blur-sm px-4 py-1 rounded-full border border-outline-variant shadow-sm text-on-surface-variant">
              <span className="text-title-sm font-title-sm whitespace-nowrap">本草小侦探</span>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="w-full py-4 px-6 flex flex-col md:flex-row justify-between items-center gap-[12px] bg-surface-container border-t border-outline-variant shrink-0 z-50">
        ...
        <div className="flex gap-4">
            <a className="text-on-surface-variant text-body-base font-body-base hover:text-primary hover:underline transition-opacity duration-200" href="#">安全须知</a>
            <a className="text-on-surface-variant text-body-base font-body-base hover:text-primary hover:underline transition-opacity duration-200" href="#">隐私政策</a>
            <a className="text-on-surface-variant text-body-base font-body-base hover:text-primary hover:underline transition-opacity duration-200" href="#">家长手册</a>
        </div>
