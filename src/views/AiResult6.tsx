...
export default function AiResult6({ navigate, uploadedImage }: { navigate: (view: string) => void, uploadedImage?: string | null }) {
  const customStyles = `
    .bg-guofeng-corners {
            ...
            <div className="paper-card rounded-xl w-full flex-1 min-h-0 p-3 flex flex-col relative">
              ...
              <div className="card-content w-full flex-grow relative rounded-lg overflow-hidden border-2 border-primary-container/50 bg-surface-container-lowest flex items-center justify-center min-h-[120px]">
                <img 
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuB02Lc8ca9l-BTr1sFXSucRORLrYoCGZu8w0kTKBdWEH980iPHEm3ziJztwYt5dhRovpmkeo5oLnmzUrw4mur1OOowxbpZmMw3rBK14k-YzQweolYWR8f90GJdTrcuR5p2mcS8GJuTxgjqr2Czm_MDf_Ys9td2xGBXrxVWKbwFJJASGXlRC6YAg42k9MSBCDp4cbKATvWrvQPcCRMKeOk2_aVYXU-U1nVs75D83KDwluQwk1vjhPcUFjJlUSuBgJgfizgWBVHTUsbo" 
                />
              </div>
            </div>
          </div>
                ...
                <div className="flex justify-between items-start border-b border-surface-variant pb-4 mb-2">
                  <div>
                    <div className="flex items-center gap-3">
                      <h2 className="text-display-lg font-display-lg text-on-surface">桂花</h2>
                      <span className="text-title-sm font-title-sm text-outline">(Guì Huā)</span>
                    </div>
                ...
                <div className="flex-grow overflow-y-auto pr-2 space-y-4 custom-scrollbar">
                  ...
                  <div className="bg-surface-container-low rounded-lg p-3 border border-surface-variant">
                    ...
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      它的花朵小小的，像米粒一样，颜色有金黄色和银白色的，还没走到跟前就能闻到浓浓的甜香味。
                    </p>
                  </div>
                  ...
                  <div className="bg-tertiary-container/20 rounded-lg p-3 border border-tertiary-fixed-dim">
                    ...
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      传说月亮上有一棵巨大的桂树，每到中秋节，桂花就会飘落到人间，送来秋天的第一份甜蜜。
                    </p>
                  </div>
                  ...
                  <div className="bg-secondary-container/30 rounded-lg p-3 border border-secondary-fixed-dim">
                    ...
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      中秋节不仅要吃月饼，人们还会收集桂花做成美味的糕点或清香的桂花茶。
                    </p>
                  </div>
