...
export default function GameSuccess({
  ...
  return (
    <div
      className="bg-background text-on-background font-body-base flex flex-col h-screen w-full mx-auto relative overflow-hidden"
      style={{
      ...
      <main className="flex-grow flex flex-col items-center justify-center relative px-6 py-8 z-10 h-full overflow-y-auto">
        <div className="absolute inset-0 pointer-events-none overflow-hidden flex items-center justify-center">
          ...
          <div className="absolute top-10 left-20 opacity-60 hidden md:block">
            <img
              alt="Clouds"
              className="w-48 h-auto mix-blend-multiply opacity-50"
              src="/images/image_5778767302.png"
            />
          </div>
          {/* Bamboo Decorations */}
          <div className="absolute bottom-10 right-20 opacity-60 hidden md:block">
            <img
              alt="Bamboo Leaves"
              className="w-64 h-auto mix-blend-multiply opacity-40"
              src="/images/image_627a17f863.png"
            />
          </div>
        </div>
        ...
        <div className="relative w-full max-w-4xl flex flex-col items-center z-20 bg-surface/90 backdrop-blur-sm rounded-[32px] shadow-xl border-4 border-surface-container-high p-6 md:p-10 pt-16 mt-12 mb-8">
          ...
          <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
            ...
            {/* Sparkle Icons */}
            <span
              className="material-symbols-outlined absolute -top-4 -left-6 text-yellow-400 text-4xl pulse-slow"
              style={{ fontVariationSettings: "'FILL' 1" }}
            >
              stars
            </span>
            <span
              className="material-symbols-outlined absolute -top-2 -right-8 text-yellow-400 text-5xl pulse-slow delay-150"
              style={{ fontVariationSettings: "'FILL' 1" }}
            >
              colors_spark
            </span>
          ...
          <div className="relative mb-8 mt-4">
            ...
            <div className="relative z-10 w-48 h-48 md:w-64 md:h-64 flex items-center justify-center">
              <img
                ...
                src="/images/image_bc3d47f15b.png"
              />
            </div>
            {/* Floating Leaves */}
            <span
              className="material-symbols-outlined absolute top-10 -left-10 text-primary-container text-3xl animate-bounce"
              style={{ animationDuration: "3s" }}
            >
              eco
            </span>
            <span
              className="material-symbols-outlined absolute bottom-10 -right-10 text-primary-container text-4xl animate-bounce"
          ...
          <div className="w-full bg-surface-container-low rounded-[24px] p-6 mb-10 border border-outline-variant/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { name: "金银花", img: "/images/image_f75d4835c7.png" },
                { name: "山楂", img: "/images/image_271836f8b5.png" },
                { name: "菊花", img: "/images/image_de4bfb4965.png" },
              ].map((item, i) => (
                <div
                  key={i}
                  className="relative group bg-surface-container-lowest rounded-xl p-3 shadow-sm hover:shadow-md transition-shadow border border-outline-variant/20 flex flex-col items-center cursor-pointer"
                >
                  <div className="absolute -top-3 -right-3 bg-error text-on-error font-label-caps text-[10px] px-2 py-1 rounded-full shadow-sm z-10 transform rotate-12">
                    NEW
                  </div>
