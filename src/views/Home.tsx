      ...
      <main className="flex-1 min-h-0 w-full max-w-[1600px] mx-auto p-4 md:p-6 bamboo-texture flex flex-col gap-4 md:gap-6 overflow-hidden">
        ...
        <section className="h-[35%] md:h-[40%] shrink-0 relative rounded-3xl overflow-hidden shadow-scroll group">
          <div
            ...
            style={{ backgroundImage: "url('/images/image_3b88ccd654.png')" }}
          ></div>
          ...
          <div className="relative z-10 h-full p-6 md:p-10 flex flex-col justify-center w-full md:w-3/4 lg:w-2/3">
            ...
            <h1 className="text-3xl md:text-5xl font-display-lg text-primary mb-2 md:mb-4 font-guofeng leading-tight">
              小小本草官
            </h1>
            <p className="text-lg md:text-2xl font-headline-md text-on-surface mb-2 md:mb-3">
              AI驱动的儿童中华本草文化互动学习平台
            </p>
            <p className="text-sm md:text-base text-on-surface-variant mb-6 max-w-md hidden sm:block">
              "识一味本草，听一个故事，懂一种文化。"
            </p>
            ...
            >
              <span className="material-symbols-outlined mr-2 group-hover/btn:rotate-12 transition-transform">
                explore
              </span>
              开启探索之旅
            </button>
        ...
        <div className="flex-1 min-h-0 flex flex-col lg:flex-row gap-4 md:gap-6">
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-4 h-full">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-on-surface-variant line-clamp-2 leading-snug">
                    拍一拍，认识身边的本草朋友.
                  </p>
                </div>
              </div>
          ...
          <section className="flex-1 lg:flex-[1.5] bg-surface-bright rounded-3xl p-6 md:p-8 shadow-scroll relative overflow-hidden border border-surface-container-high flex flex-col min-h-0">
            ...
            <div className="flex justify-between items-start mb-4 relative z-10 shrink-0">
              <div>
                <h2 className="text-3xl md:text-4xl font-display-lg text-primary font-guofeng mb-1">
                  金银花
                </h2>
                <p className="text-sm text-secondary font-guofeng">
                  Honeysuckle
                </p>
              </div>
            ...
            <div className="flex-1 min-h-0 relative flex items-center justify-center py-4 z-10">
              <div className="h-full aspect-square max-h-[300px] md:max-h-full rounded-full border-8 border-surface shadow-lg overflow-hidden relative group">
                <img
                  ...
                  src="/images/image_582d7d2b5a.png"
                />
            ...
            <div className="shrink-0 mt-4 relative z-10">
              ...
              >
                开始学习
                <span className="material-symbols-outlined ml-2 text-lg group-hover/btn2:translate-x-1 transition-transform">
                  arrow_forward
                </span>
              </button>
            </div>
