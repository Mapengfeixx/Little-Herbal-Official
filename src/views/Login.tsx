...
export default function Login({
  ...
  const bgUrl = "/images/image_5cc102c52b.png";
      ...
      <main className="relative z-10 flex h-screen w-full items-center justify-center md:justify-end px-4 sm:px-8 md:pr-16 lg:pr-32">
        ...
        <div className="relative w-full max-w-[420px] ai-glow-border scroll-edge">
          ...
          <div className="bg-surface/85 backdrop-blur-xl border border-tertiary-container/50 rounded-2xl p-8 sm:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.08)] bg-cloud-pattern relative overflow-hidden flex flex-col gap-6">
            ...
            <span className="material-symbols-outlined absolute top-4 right-6 text-primary-fixed-dim/40 rotate-45 text-4xl">
              energy_savings_leaf
            </span>
            <span className="material-symbols-outlined absolute bottom-24 left-4 text-primary-fixed-dim/30 -rotate-12 text-3xl">
              psychiatry
            </span>
              ...
              <div className="space-y-1">
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <span className="material-symbols-outlined text-primary group-focus-within:text-surface-tint transition-colors">
                      local_florist
                    </span>
                  </div>
                  <input
