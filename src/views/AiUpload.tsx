...
export default function AiUpload({ navigate, uploadedImage, setUploadedImage }: { navigate: (view: string) => void, uploadedImage?: string | null, setUploadedImage: (url: string | null) => void }) {
    ...
    <div className="bg-guofeng-texture text-on-background font-body-base antialiased h-screen w-full flex flex-col overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col md:flex-row w-full max-w-7xl mx-auto px-6 py-6 gap-8 overflow-hidden relative z-10">
        ...
        <section className="flex-1 flex flex-col justify-between h-full space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-display-lg font-display-lg text-primary tracking-tight">AI识本草</h1>
          ...
          <div className="bg-surface/80 backdrop-blur-md rounded-2xl p-6 shadow-sm border border-surface-variant">
            ...
            <div className="flex items-center justify-between relative">
              ...
              <div className="relative z-10 flex flex-col items-center gap-2">
                ...
                <span className="text-label-caps font-label-caps text-on-surface-variant">1. 上传图片</span>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center gap-2">
                ...
                <span className="text-label-caps font-label-caps text-on-surface-variant">2. AI观察特征</span>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center gap-2">
                ...
                <span className="text-label-caps font-label-caps text-on-surface-variant">3. 生成知识卡</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar pb-2">
              <div className="flex flex-wrap gap-3 content-start">
                ...
                {[
                  ...
                  <div key={idx} className="bg-surface shadow-sm hover:shadow-md transition-shadow duration-200 rounded-xl p-2 border border-surface-variant flex items-center gap-3 pr-4 cursor-default">
                    <div className="w-8 h-8 rounded-full bg-secondary-container flex items-center justify-center text-secondary">
                      <span className="material-symbols-outlined text-sm">{herb.icon}</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-body-base font-body-base text-on-surface font-semibold leading-tight">{herb.name}</span>
                      <span className="text-[10px] text-primary-container bg-primary-container/10 px-1.5 py-0.5 rounded-sm mt-0.5 w-max">可识别</span>
                    </div>
                  </div>
                ))}
        ...
        <section className="flex-1 flex flex-col justify-center items-center h-full">
          ...
          >
            ...
            {uploadedImage ? (
                <img src={uploadedImage} alt="Preview" className="absolute inset-0 w-full h-full object-cover z-10" />
            ) : (
                <div className="flex flex-col items-center gap-4 z-10">
                  ...
                  <div className="text-center">
                    <p className="text-title-sm font-title-sm text-on-surface-variant font-medium">点击上传图片，或将图片拖到这里</p>
                    <p className="text-label-caps font-label-caps text-outline mt-1">支持 JPG, PNG 格式</p>
                  </div>
                </div>
            )}
          </div>
          ...
          <div className="mt-8 flex gap-4 w-full max-w-lg">
            <div className="flex-[3] flex flex-col gap-4">
              ...
              >
                ...
                <span className="material-symbols-outlined relative z-10">upload</span>
      ...
      <footer className="bg-surface-container-highest/80 backdrop-blur-sm border-t border-outline-variant/30 py-3 px-6 shrink-0 relative z-20">
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 text-center">
          <span className="material-symbols-outlined text-error text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>info</span>
