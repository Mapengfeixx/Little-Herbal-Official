...
export default function AiResult({ navigate, uploadedImage }: { navigate: (view: string) => void, uploadedImage?: string | null }) {
  const customStyles = `
    .bg-guofeng-corners {
            ...
            <div className="paper-card rounded-xl w-full flex-1 min-h-0 p-3 flex flex-col relative">
              ...
              <div className="card-content w-full flex-grow relative rounded-lg overflow-hidden border-2 border-primary-container/50 bg-surface-container-lowest flex items-center justify-center min-h-[120px]">
                <img 
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAVjRsZA9nuu_WQeEanXqyqajYyNCgB4hzYAuNlqzHm23ZmVJR3jwdF2_WynxgCHrMdVQsNYRFNDXxHHMO7pY9Du_MoppF2tOOuDmnvzAobd9Tk0Ha9xtWjqjPyiq7ZZ_k10elYYCFqhhINTaQheaXPQMd17R1BoBMIAz3oS714fAkmUpldp0B5047DxhPc14cdUg8IBBOhcM2wwizsZqtZUAeQhd2nF_QL1GlMyDJfyQs8kqeZxP-OrvJOIrJPmeRbBBcmMBbtP_c" 
                />
              </div>
            </div>
          </div>
                ...
                <div className="flex justify-between items-start border-b border-surface-variant pb-4 mb-2">
                  <div>
                    <div className="flex items-center gap-3">
                      <h2 className="text-display-lg font-display-lg text-on-surface">山楂</h2>
                      <span className="text-title-sm font-title-sm text-outline">(Shān Zhā)</span>
                    </div>
                ...
                <div className="flex-grow overflow-y-auto pr-2 space-y-4 custom-scrollbar">
                  ...
                  <div className="bg-secondary-container/30 rounded-lg p-3 border border-secondary-fixed-dim">
                    <h3 className="text-title-sm font-title-sm text-on-secondary-container flex items-center gap-2 mb-1">
                      <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>festival</span>
                      文化小知识
                    </h3>
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      它是冰糖葫芦的主要原料，深受小朋友喜爱。
