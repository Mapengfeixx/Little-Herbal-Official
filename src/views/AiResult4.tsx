...
export default function AiResult4({ navigate, uploadedImage }: { navigate: (view: string) => void, uploadedImage?: string | null }) {
  const customStyles = `
    .bg-guofeng-corners {
            ...
            <div className="paper-card rounded-xl w-full flex-1 min-h-0 p-3 flex flex-col relative">
              ...
              <div className="card-content w-full flex-grow relative rounded-lg overflow-hidden border-2 border-primary-container/50 bg-surface-container-lowest flex items-center justify-center min-h-[120px]">
                <img 
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBWghSTM7Hy-xjJp5l-YuwsFWdgM_bVdfjiMi17LWkgTtn3qI_tUneA5TRVZbSXvDBV1TAHaKD3hR_NUXt-AIkGGk5Ey04yBentw6_NpAc4pvG5wCfQCMVjJ5zZ4OUfcNKaVjermxa6-dtuqKMXPF3ztRRjBtAiVObRh1CBw-le5ZFuticT6J79sXcL67xkb9LAWLdxwbSzzD_xsKQy1jsZGoenzzWQIIQkcR_noLftYH9fR97G8Jri0ZtNyUDRkwOQVYFMRJBk_oI" 
                />
              </div>
            </div>
          </div>
                ...
                <div className="flex justify-between items-start border-b border-surface-variant pb-4 mb-2">
                  <div>
                    <div className="flex items-center gap-3">
                      <h2 className="text-display-lg font-display-lg text-on-surface">艾草</h2>
                      <span className="text-title-sm font-title-sm text-outline">(Ài Cǎo)</span>
                    </div>
