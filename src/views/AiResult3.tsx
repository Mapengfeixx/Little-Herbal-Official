...
export default function AiResult3({ navigate, uploadedImage }: { navigate: (view: string) => void, uploadedImage?: string | null }) {
  const customStyles = `
    .bg-guofeng-corners {
            ...
            <div className="paper-card rounded-xl w-full flex-1 min-h-0 p-3 flex flex-col relative">
              ...
              <div className="card-content w-full flex-grow relative rounded-lg overflow-hidden border-2 border-primary-container/50 bg-surface-container-lowest flex items-center justify-center min-h-[120px]">
                <img 
                  ...
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCU2PnsuDQt0ec5Sk3RDLPI_mIZy5Az2-q9oh3UOk3hnQ2A3t_rbGEcUKFCuEHP4oTahhhh0Tr0up57iWXn8_JZRsjF0tDeplgoYEQcb4cguk7hfNiS_xEbneaJu0bsRobh7R1zdIQi4n-K1HwRTcvLwkHRBEknWIYNEc4aC5JB47h13gfgD4yq_0Z2laW3C85U5RFGs72d2z8c6YNyPUR2X153Q0f3V-_S2Gh_9OeHwG98gFsoWcoqia11B2NXjM-Kz5b7EXn3_XU" 
                />
              </div>
            </div>
          </div>
                ...
                <div className="flex justify-between items-start border-b border-surface-variant pb-4 mb-2">
                  <div>
                    <div className="flex items-center gap-3">
                      <h2 className="text-display-lg font-display-lg text-on-surface">薄荷</h2>
                      <span className="text-title-sm font-title-sm text-outline">(Bò He)</span>
                    </div>
                ...
                <div className="flex-grow overflow-y-auto pr-2 space-y-4 custom-scrollbar">
                  ...
                  <div className="bg-surface-container-low rounded-lg p-3 border border-surface-variant">
                    ...
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      叶子边缘有整齐的小锯齿，颜色是亮亮的绿色。摸一摸、闻一闻，会有一股凉凉的、超级清爽的味道。
                    </p>
                  </div>
                  ...
                  <div className="bg-tertiary-container/20 rounded-lg p-3 border border-tertiary-fixed-dim">
                    ...
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      薄荷被大家称为“清凉小使者”。在炎热的夏天，喝上一口薄荷水，感觉整个人都变凉快了！
                    </p>
                  </div>
                  ...
                  <div className="bg-secondary-container/30 rounded-lg p-3 border border-secondary-fixed-dim">
                    ...
                    <p className="text-body-base font-body-base text-on-surface-variant pl-8">
                      薄荷不仅可以用来泡茶，古人还会把它挂在床头，味道可以驱走夏天讨厌的小蚊虫。
                    </p>
                  </div>
